...
for mechanisme in list_mechanisme:
    for scenario in list_scenarios:
            ...
            for sig_level in list_sig_level:  #np.arange(0.01, 0.2, 0.04).tolist():
                ...
                for data_path in tqdm(data_files):
                    ...
                    for num_inter in list_num_inters:
                        ...
                        try:
                            pred_root_causes = cloud_ranger(data=actual_data, anomalous_nodes=anomaly_nodes, anomalies_start_time=anomalies_start_time,
        ...
        simple_res_path = os.path.join('..', '..', 'Results_sim_20000', mechanisme, scenario, 'CloudRanger.json')
        with open(simple_res_path, 'w') as json_file:
            json.dump(simple_final_res, json_file)

        complete_res_path = os.path.join('..', '..', 'Results_com_20000', mechanisme, scenario, 'CloudRanger.json')
