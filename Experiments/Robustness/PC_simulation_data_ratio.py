...
list_mechanisme = ['one_path'] # ['different_path', 'one_path']
list_process = ['E1'] # ['E1', 'E2']
list_scenarios = ['uncertain_0.3_SL'] # ['certain', 'certain_SL', 'uncertain_0.3', 'uncertain_0.3_SL']
# list_sampling_number = [20, 50, 200] # [10, 100, 500, 1000, 2000] # [10, 100, 500, 1000, 2000]
# list_normal_ratio = [0.8, 0.85, 0.9, 0.95, -1]
...
for mechanisme in list_mechanisme:
    for process in list_process:
        for scenario in list_scenarios:
                ...
                for sig_level in list_sig_level:  #np.arange(0.01, 0.2, 0.04).tolist():
                    ...
                    for data_path in tqdm(data_files):
                        ...
                        for column in param_data.columns:
                            param_data[column] = param_data[column].values >= param_threshold_dict[column][0]
            ...
            simple_res_path = os.path.join('../..', 'Results_sim_VR', mechanisme, scenario, process + 'TRCA.json')  # '_PC_E.json'
            with open(simple_res_path, 'w') as json_file:
                json.dump(simple_final_res, json_file)

            complete_res_path = os.path.join('../..', 'Results_com_VR', mechanisme, scenario, process + 'TRCA.json') # '_PC_E.json'
