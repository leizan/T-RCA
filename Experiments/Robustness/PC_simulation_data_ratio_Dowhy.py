...
list_mechanisme = ['Dowhy']
list_scenarios = ['one_path'] # ['different_path', 'one_path']
...
# normal_ratio = 0.9
abnormal_ratio = 0
# list_normal_ratio = [0.8, 0.85, 0.9, 0.95]
...
for mechanisme in list_mechanisme:
    for scenario in list_scenarios:
        ...
        for normal_ratio in list_normal_ratio:
            ...
            for sig_level in list_sig_level:  #np.arange(0.01, 0.2, 0.04).tolist():
                ...
                for data_path in tqdm(data_files):
                    ...
                    results = pcmci.run_pcmciplus(tau_min=1, tau_max=gamma_max, pc_alpha=sig_level)
        ...
        simple_res_path = os.path.join('..', '..', 'Results_sim_VR', mechanisme, scenario, 'TRCA.json')
        with open(simple_res_path, 'w') as json_file:
            json.dump(simple_final_res, json_file)

        complete_res_path = os.path.join('..', '..', 'Results_com_VR', mechanisme, scenario, 'TRCA.json')
