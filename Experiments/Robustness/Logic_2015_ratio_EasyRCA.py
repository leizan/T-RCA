...
for mechanisme in list_mechanisme:
    for scenario in list_scenarios:
        ...
        simple_res_path = os.path.join('..', '..', 'Results_sim_VR', mechanisme, scenario, 'dis_2015.json')
        with open(simple_res_path, 'w') as json_file:
            json.dump(simple_final_res, json_file)

        complete_res_path = os.path.join('..', '..', 'Results_com_VR', mechanisme, scenario, 'dis_2015.json')
