...
for mechanisme in list_mechanisme:
    for scenario in list_scenarios:
        ...
        # simple_res_path = os.path.join('..', '..', 'Results_sim_20000', mechanisme, scenario, 'cloudrange.json')
        # with open(simple_res_path, 'r') as json_file:
        #     simple_final_res = json.load(json_file)
        #
        # complete_res_path = os.path.join('..', '..', 'Results_com_20000', mechanisme, scenario, 'cloudrange.json')
                ...
                for data_path in tqdm(data_files):
                    ...
                    for num_inter in list_num_inters:
                        ...
                        try:
                            ...
                            pred_root_causes = cloud_ranger(data=actual_data, anomalous_nodes=anomalous_node, anomalies_start_time=anomalies_start_time,
                                                            anomaly_length=anomaly_length, sig_threshold=sig_level)
                        except:
                            pred_root_causes = []
