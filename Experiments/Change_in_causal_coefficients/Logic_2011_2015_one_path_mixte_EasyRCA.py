...
list_sampling_number = [10, 100, 500, 1000, 2000]
list_num_inters = [2]
...
for mechanisme in list_mechanisme:
    for scenario in list_scenarios:
        ...
        simple_res_path = os.path.join('..', '..', 'Results_sim_20000', mechanisme, scenario, 'no_dis_2015.json')
        with open(simple_res_path, 'w') as json_file:
            json.dump(simple_final_res, json_file)

        complete_res_path = os.path.join('..', '..', 'Results_com_20000', mechanisme, scenario, 'no_dis_2015.json')
